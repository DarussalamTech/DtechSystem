...
class UltimateSocialDeux {
	...
	public function custom_css() {
		if ( intval( get_query_var( 'us_ccss' ) ) == 1 ) {
			$plugin_font_dir = plugins_url( 'assets/css/font',__FILE__ );
			...
			ob_start();
				...
				printf(".us_floating .us_wrapper .us_button { width: 45px; -webkit-transition: width %dms ease-in-out, background-color 400ms ease-out; -moz-transition: width %dms ease-in-out, background-color 400ms ease-out; -o-transition: width %dms ease-in-out, background-color 400ms ease-out; transition: width %dms ease-in-out, background-color 400ms ease-out; }", $floating_speed, $floating_speed, $floating_speed, $floating_speed );
				printf(".us_floating .us_wrapper .us_button:hover { width: 90px;-webkit-transition: width %dms ease-in-out, background-color 400ms ease-out; -moz-transition: width %dms ease-in-out, background-color 400ms ease-out; -o-transition: width %dms ease-in-out, background-color 400ms ease-out; transition: width %dms ease-in-out, background-color 400ms ease-out; }", $floating_speed, $floating_speed, $floating_speed, $floating_speed);
				printf(".us_button:hover, .us_fan_count_button:hover { background-color:%s; }", $hover_color);
				printf(".us_button { -moz-border-radius-topleft: %spx; -moz-border-radius-topright: %spx; -moz-border-radius-bottomright: %spx; -moz-border-radius-bottomleft: %spx; border-top-left-radius: %spx; border-top-right-radius: %spx; border-bottom-right-radius: %spx; border-bottom-left-radius: %spx; -webkit-border-top-left-radius: %spx; -webkit-border-top-right-radius: %spx; -webkit-border-bottom-right-radius: %spx; -webkit-border-bottom-left-radius: %spx; }", $border_radius_sharing_top_left, $border_radius_sharing_top_right, $border_radius_sharing_bottom_right, $border_radius_sharing_bottom_left, $border_radius_sharing_top_left, $border_radius_sharing_top_right, $border_radius_sharing_bottom_right, $border_radius_sharing_bottom_left, $border_radius_sharing_top_left, $border_radius_sharing_top_right, $border_radius_sharing_bottom_right, $border_radius_sharing_bottom_left );
				printf(".us_fan_count_button { -moz-border-radius-topleft: %spx; -moz-border-radius-topright: %spx; -moz-border-radius-bottomright: %spx; -moz-border-radius-bottomleft: %spx; border-top-left-radius: %spx; border-top-right-radius: %spx; border-bottom-right-radius: %spx; border-bottom-left-radius: %spx; -webkit-border-top-left-radius: %spx; -webkit-border-top-right-radius: %spx; -webkit-border-bottom-right-radius: %spx; -webkit-border-bottom-left-radius: %spx; }", $border_radius_fan_count_top_left, $border_radius_fan_count_top_right, $border_radius_fan_count_bottom_right, $border_radius_fan_count_bottom_left, $border_radius_fan_count_top_left, $border_radius_fan_count_top_right, $border_radius_fan_count_bottom_right, $border_radius_fan_count_bottom_left, $border_radius_fan_count_top_left, $border_radius_fan_count_top_right, $border_radius_fan_count_bottom_right, $border_radius_fan_count_bottom_left );
				printf("div[class*='us_facebook'] { background-color:%s; }", $facebook_color);
				printf("div[class*='us_twitter'] { background-color:%s; }", $twitter_color);
				printf("div[class*='us_google'] { background-color:%s; }", $googleplus_color);
				printf("div[class*='us_delicious'] { background-color:%s; }", $delicious_color);
				printf("div[class*='us_stumble'] { background-color:%s; }", $stumble_color);
				printf("div[class*='us_linkedin'] { background-color:%s; }", $linkedin_color);
				printf("div[class*='us_pinterest'] { background-color:%s; }", $pinterest_color);
				printf("div[class*='us_buffer'] { background-color:%s; }", $buffer_color);
				printf("div[class*='us_reddit'] { background-color:%s; }", $reddit_color);
				printf("div[class*='us_vkontakte'] { background-color:%s; }", $vkontakte_color);
				printf(".us_mail { background-color:%s; }", $mail_color);
				printf("div[class*='us_love'] { background-color:%s; }", $love_color);
				printf("div[class*='us_pocket'] { background-color:%s; }", $pocket_color);
				printf("div[class*='us_tumblr'] { background-color:%s; }", $tumblr_color);
				printf("div[class*='us_print'] { background-color:%s; }", $print_color);
				printf("div[class*='us_flipboard'] { background-color:%s; }", $flipboard_color);
				printf("div[class*='us_comments']{ background-color:%s; }", $comments_color);
				printf("div[class*='us_feedly'] { background-color:%s; }", $feedly_color);
				printf("div[class*='us_youtube'] { background-color:%s; }", $youtube_color);
				printf("div[class*='us_vimeo'] { background-color:%s; }", $vimeo_color);
				printf("div[class*='us_dribbble'] { background-color:%s; }", $dribbble_color);
				printf("div[class*='us_envato'] { background-color:%s; }", $envato_color);
				printf("div[class*='us_github'] { background-color:%s; }", $github_color);
				printf("div[class*='us_soundcloud'] { background-color:%s; }", $soundcloud_color);
				printf("div[class*='us_instagram'] { background-color:%s; }", $instagram_color);
				printf("div[class*='us_feedpress'] { background-color:%s; }", $feedpress_color);
				printf("div[class*='us_mailchimp'] { background-color:%s; }", $mailchimp_color);
				printf("div[class*='us_flickr'] { background-color:%s; }", $flickr_color);
				printf("div[class*='us_members'] { background-color:%s; }", $members_color);
				printf(".us_posts_fan_count { background-color:%s; }", $posts_color);

				printf('@font-face { font-family: "ultimate-social";src:url("%s/ultimate-social.eot");src:	url("%s/ultimate-social.eot#iefix") format("embedded-opentype"),url("%s/ultimate-social.woff") format("woff"), url("%s/ultimate-social.ttf") format("truetype"), url("%s/ultimate-social.svg#ultimate-social") format("svg");font-weight: normal;font-style: normal;}', $plugin_font_dir, $plugin_font_dir, $plugin_font_dir, $plugin_font_dir, $plugin_font_dir);
				exit;
			ob_clean();
		}
	}
	...
	*/
	public function register_styles() {
		...
		wp_register_style( 'us_ccss', home_url( '/index.php?us_ccss=1' ) );
	...
	*/
	...
	public static function mail_replace_vars( $string, $url, $sender_name, $sender_email ) {
		...
		$string = str_replace('{sender_name}', $site_url, $string);
		$string = str_replace('{sender_email}', $site_url, $string);
	...
	public static function buttons($sharetext = '', $networks = array(), $url = '', $align = "center", $count = true, $native = false) {
		...
		if ($sharetext) {
			$output .= sprintf('<div class="us_button us_share_text"><span>%s</span></div>', $sharetext);
		}
	...
	public static function total_button($url, $text, $networks) {
		...
		if( count($networks) === 1 ) {
			$buttons .= 'data-facebook="true" data-googleplus="true" data-vkontakte="true" data-stumble="true" data-twitter="true" data-buffer="true" data-delicious="true" data-pinterest="true" data-reddit="true" data-comments="true" data-love="true" data-pocket="true" data-print="true" data-tumblr="true" data-flipboard="true" data-mail="true" data-linkedin="true"';
			...
			foreach ($networks as $key => $button) {
				...
				if ($button == 'facebook_native') {
					$button = 'facebook';
				} elseif($button == 'google_native' || $button == 'googleplus_native' || $button == 'google' ) {
					$button = 'googleplus';
				} elseif($button == 'vkontakte_native' ) {
					$button = 'vkontakte';
				} elseif($button == 'total' ) {
					$button = '';
				}
		...
		$total_shares_text = ( self::opt('us_total_shares_text', 'us_basic') ) ? self::opt('us_total_shares_text', 'us_basic'): '';

		$button = sprintf('<div class="us_total us_button" data-url="%s"%s><a class="us_box" href="#"><div class="us_count"><i class="us-icon-spin us-icon-spinner"></i></div><div class="us_share">%s</div></a></div>', $url, $buttons, $total_shares_text);
	...
	public static function google_button($url, $text, $count = true, $native = false, $both = false) {
		...
		$transient = get_transient( 'us_counts_googlePlus_'.$url );

		$transient_class = ( $transient ) ? ' us_transient': '';

		$number = ( $transient ) ? self::number_format($transient): '<i class="us-icon-spin us-icon-spinner"></i>';

		$counter = ( $count && !$both ) ? sprintf('<div class="us_count">%s</div>', $number): '';
		...
		$button = sprintf('<div class="us_googleplus%s%s%s%s us_button" data-url="%s" data-text="%s"><a class="us_box" href="#" data-url="%s"><div class="us_share"><i class="us-icon-google"></i></div>%s</a>%s</div>', $counter_class, $native_class, $transient_class, $both_class, $url, strip_tags($text), $url, $counter, $native_markup );
	...
	public static function pinterest_button($url, $text, $count = true) {
		...
		$transient = get_transient( 'us_counts_pinterest_'.$url );

		$transient_class = ( $transient ) ? ' us_transient': '';

		$number = ( $transient ) ? self::number_format($transient): '<i class="us-icon-spin us-icon-spinner"></i>';

		$counter = ( $count ) ? sprintf('<div class="us_count">%s</div>', $number): '';

		$counter_class = ( $count ) ? '': ' us_no_count';

		$button = sprintf('<div class="us_pinterest%s%s us_button" data-url="%s" data-text="%s"><a class="us_box" href="#"><div class="us_share"><i class="us-icon-pinterest"></i></div>%s</a></div>', $counter_class, $transient_class, $url, strip_tags($text), $counter);
	...
	public static function stumble_button($url, $text, $count = true) {
		...
		$transient = get_transient( 'us_counts_stumbleupon_'.$url );
		...
		$button = sprintf('<div class="us_stumble%s%s us_button" data-url="%s" data-text="%s" ><a class="us_box" href="#"><div class="us_share"><i class="us-icon-stumbleupon"></i></div>%s</a></div>', $counter_class, $transient_class, $url, strip_tags($text), $counter );
	...
	public static function reddit_button($url, $text, $count = true) {
		...
		$transient = get_transient( 'us_counts_reddit_'.$url );
		...
		$button = sprintf('<div class="us_reddit%s%s us_button" data-url="%s" data-text="%s" ><a class="us_box" href="#"><div class="us_share"><i class="us-icon-reddit"></i></div>%s</a></div>', $counter_class, $transient_class, $url, strip_tags($text), $counter );
	...
	public static function comments_button($url, $count = true) {
		...
		if ( $post_id != 0 && comments_open() ){
			...
			$number = ( self::number_format( get_comments_number( $post_id ) ) ) ? self::number_format( get_comments_number( $post_id ) ): '';

			$counter = ( $count ) ? sprintf('<div class="us_count">%s</div>', $number): '';

			$counter_class = ( $count ) ? '': ' us_no_count';

			$button = sprintf('<div class="us_comments%s us_button"><a class="us_box" href="%s#respond"><div class="us_share"><i class="us-icon-comments"></i></div>%s</a></div>', $counter_class, $url, $counter);
	...
	public static function love_button($url, $count = true) {
		...
		$button = sprintf('<div class="us_love%s us_button"><a class="us_box%s" href="#" data-user_id="%s" data-url="%s" data-count="%s"><div class="us_share"><i class="us-icon-love"></i></div>%s</a></div>', $counter_class, $loved_class, $user_id, $url, $number, $counter);
	...
	public static function vkontakte_button($url, $text, $media, $count = true, $native = false, $both = false) {
		...
		$transient = get_transient( 'us_counts_vkontakte_'.$url );
		...
		$button = sprintf('<div class="us_vkontakte%s%s%s%s us_button" data-url="%s" data-text="%s"><a class="us_box" href="#" data-url="%s"><div class="us_share"><i class="us-icon-vkontakte"></i></div>%s</a>%s</div>', $counter_class, $native_class, $transient_class, $both_class, $url, strip_tags($text), $url, $counter, $native_markup );
	...
	public function us_counts() {
		...
		$url_transient = urldecode($_GET['url']);
		$type = $_GET['type'];
		...
		if(filter_var($_GET['url'], FILTER_VALIDATE_URL)){
			switch($type) {
				case 'googlePlus':
					...
					$transient = get_transient( 'us_counts_googlePlus_'.$url_transient );
					...
					if ( $transient ) {
						...
						set_transient( 'us_counts_googlePlus_'.$url_transient, $json['count'], $expire );
					}
					break;

				case 'stumbleupon':
					$transient = get_transient( 'us_counts_stumbleupon_'.$url_transient );
					...
					if ( $transient ) {
						...
						set_transient( 'us_counts_stumbleupon_'.$url_transient, $json['count'], $expire );
					}

					break;

				case 'pinterest':
					$transient = get_transient( 'us_counts_pinterest_'.$url_transient );
					...
					if ( $transient ) {
						...
						set_transient( 'us_counts_pinterest_'.$url_transient, $json['count'], $expire );
					}
					break;

				case 'reddit':
					$transient = get_transient( 'us_counts_reddit_'.$url_transient );
					...
					if ( $transient ) {
						...
						set_transient( 'us_counts_reddit_'.$url_transient, $json['count'], $expire );
					}
					break;

				case 'vkontakte':
					$transient = get_transient( 'us_counts_vkontakte_'.$url_transient );
					...
					if ( $transient ) {
						...
						set_transient( 'us_counts_vkontakte_'.$url_transient, $json['count'], $expire );
					}
					break;

					case 'comments':
						$post_id = url_to_postid( $url_transient );

						$json['count'] = ( self::number_format( get_comments_number( $post_id ) ) ) ? self::number_format( get_comments_number( $post_id ) ): 0;
					...
					case 'love':
						...
						$json['count'] = ( !empty( $options['data'][$url_transient]['count'] ) ) ? $options['data'][$url_transient]['count']: 0;
	...
	public function remote_get( $url , $json = true) {

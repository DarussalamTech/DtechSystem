...
new WPUpdatesPluginUpdater_414( 'http://wp-updates.com/api/2/plugin', plugin_basename(__FILE__) );
*/

if( !class_exists('WPUpdatesPluginUpdater_414') ) {
    class WPUpdatesPluginUpdater_414 {
